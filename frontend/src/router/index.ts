                    ...
                    },
                    {
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/xunlianyingxinxidetail/:id",
                                    name: "xunlianyingxinxidetail",
                                    meta: {
                                        title: "训练营信息",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/xunlianyingxinxi/detail.vue"),
                                },
                                {
                                    path: "/xunlianyingxinxilist",
                                    name: "xunlianyingxinxilist",
                                    meta: {
                                        title: "训练营信息",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/xunlianyingxinxi/list.vue"),
                                },
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/yuyueguanlidetail/:id",
                                    name: "yuyueguanlidetail",
                                    meta: {
                                        title: "预约管理",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/yuyueguanli/detail.vue"),
                                },
                                {
                                    path: "/yuyueguanlilist",
                                    name: "yuyueguanlilist",
                                    meta: {
                                        title: "预约管理",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/yuyueguanli/list.vue"),
                                },
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/bisaiguanlidetail/:id",
                                    name: "bisaiguanlidetail",
                                    meta: {
                                        title: "比赛管理",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/bisaiguanli/detail.vue"),
                                },
                                {
                                    path: "/bisaiguanlilist",
                                    name: "bisaiguanlilist",
                                    meta: {
                                        title: "比赛管理",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/bisaiguanli/list.vue"),
                                },
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/qicaiguanlidetail/:id",
                                    name: "qicaiguanlidetail",
                                    meta: {
                                        title: "器材管理",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/qicaiguanli/detail.vue"),
                                },
                                {
                                    path: "/qicaiguanlilist",
                                    name: "qicaiguanlilist",
                                    meta: {
                                        title: "器材管理",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/qicaiguanli/list.vue"),
                                },
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/xunlianxiangmudetail/:id",
                                    name: "xunlianxiangmudetail",
                                    meta: {
                                        title: "训练项目",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/xunlianxiangmu/detail.vue"),
                                },
                                {
                                    path: "/xunlianxiangmulist",
                                    name: "xunlianxiangmulist",
                                    meta: {
                                        title: "训练项目",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/xunlianxiangmu/list.vue"),
                                },
                    ...
                    
                        {
                            ...
                            children: [
                                ...
                                {
                                    path: "/xunlianrenyuandetail/:id",
                                    name: "xunlianrenyuandetail",
                                    meta: {
                                        title: "训练人员",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/xunlianrenyuan/detail.vue"),
                                },
                                {
                                    path: "/xunlianrenyuanlist",
                                    name: "xunlianrenyuanlist",
                                    meta: {
                                        title: "训练人员",
                                        icon: "&#xe90f;", // 图标
                                    },
                                    component: () => import("@/views/xunlianrenyuan/list.vue"),
                                },
