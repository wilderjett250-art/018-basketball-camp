        ...
        <div class="layout-padding">
            <el-form inline :model="query" label-suffix=":">
                <el-form-item label="用户ID"  prop="yonghuming">
                    ...
                    <el-button v-if="isgrAuth('yuyueguanli','删除')" icon="ele-Delete" @click="listdel()" :disabled="isdel" type="danger">多选删除</el-button>
                    <el-button v-if="isgrAuth('yuyueguanli','新增')" icon="ele-Plus" type="success" @click="add()">新增</el-button>
                                                                            </el-form-item>
            </el-form>
            ...
            <el-table
                ...
                <el-table-column type="selection" width="55" />
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="xunlianyingmingcheng" label="训练营名称">

                                    <template #default="{row}">
                                        {{row.xunlianyingmingcheng}}
                                    </template>
                            ...
                            <el-table-column header-align="center"  align="center" prop="xunlianyingtupian" label="训练营图片">

                                <template #default="{row}">
                                    <img v-if="row.xunlianyingtupian" :src="row.xunlianyingtupian" width="100" height="100">
                                    <div v-else>无图片</div>
                                </template>

                            </el-table-column>
                                                                                                                                                                    <el-table-column header-align="center"  align="center" prop="yuyueren" label="预约人">
                                    ...
                                    <template #default="{row}">
                                        {{row.yuyueren}}
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="yuyuerendianhua" label="预约人电话">
                                    ...
                                    <template #default="{row}">
                                        {{row.yuyuerendianhua}}
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="yuyuerennianling" label="预约人年龄">

                                    <template #default="{row}">
                                        {{row.yuyuerennianling}}
                                    </template>

                                </el-table-column>

                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="yuyuerenxingbie" label="预约人性别">
                                    ...
                                    <template #default="{row}">
                                        {{row.yuyuerenxingbie}}
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="yuyueshijian" label="预约时间">
                    ...
                    <template #default="{row}">
                        <el-button v-if="isgrAuth('yuyueguanli','修改')" icon="ele-Edit" @click.stop="handleEdit(row)" type="warning" link>修改</el-button>
                        <el-popconfirm  v-if="isgrAuth('yuyueguanli','删除')"  width="auto" @confirm="handleDelete(row)"  :title="`确定永久删除吗？`">
                            <template #reference>
