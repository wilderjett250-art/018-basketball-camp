        ...
        <div class="layout-padding">
            <el-form inline :model="query" label-suffix=":">
                <el-form-item label="用户ID"  prop="yonghuming">
                        ...
                        <el-form-item label="场地名称"  prop="yonghuming">
                    ...
                    <el-button v-if="isgrAuth('bisaiguanli','删除')" icon="ele-Delete" @click="listdel()" :disabled="isdel" type="danger">多选删除</el-button>
                    <el-button v-if="isgrAuth('bisaiguanli','新增')" icon="ele-Plus" type="success" @click="add()">新增</el-button>
                                                                            </el-form-item>
            </el-form>
            ...
            <el-table
                ...
                <el-table-column type="selection" width="55" />
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="changdimingcheng" label="场地名称">

                                    <template #default="{row}">
                                        {{row.changdimingcheng}}
                                    </template>
                            ...
                            <el-table-column header-align="center"  align="center" prop="changditupian" label="场地图片">

                                <template #default="{row}">
                                    <img v-if="row.changditupian" :src="row.changditupian" width="100" height="100">
                                    <div v-else>无图片</div>
                                </template>

                            </el-table-column>
                                                                                                                                                                    <el-table-column header-align="center"  align="center" prop="changdidaxiao" label="场地大小">
                                    ...
                                    <template #default="{row}">
                                        {{row.changdidaxiao}}
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="changdirenshu" label="场地人数">
                                    ...
                                    <template #default="{row}">
                                        {{row.changdirenshu}}
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                <el-table-column header-align="center"  align="center" prop="bisaishijian" label="比赛时间">
                    ...
                    <template #default="{row}">
                        <el-button v-if="isgrAuth('bisaiguanli','修改')" icon="ele-Edit" @click.stop="handleEdit(row)" type="warning" link>修改</el-button>
                        <el-popconfirm  v-if="isgrAuth('bisaiguanli','删除')"  width="auto" @confirm="handleDelete(row)"  :title="`确定永久删除吗？`">
                            <template #reference>
