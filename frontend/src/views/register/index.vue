...
<template>
    <el-dialog title="篮球训练营注册" v-model="visible"
        ...
        <div v-loading="loadding">
            ...
            >
                        ...
                        <el-form-item  v-if="tableName=='xunlianrenyuan'" label="账号" prop="zhanghao" :rules="{required: true, message: '账号为必填项！', trigger: 'blur'}">
                            <el-input v-model="formData.zhanghao" maxlength="30" clearable show-word-limit placeholder="请输入账号" />
                        </el-form-item>
                                                                                                                        

                                                        
                        <el-form-item  v-if="tableName=='xunlianrenyuan'" label="密码" prop="mima" :rules="{required: true, message: '密码为必填项！', trigger: 'blur'}">
                            <el-input v-model="formData.mima" maxlength="30" clearable show-word-limit placeholder="请输入密码" />
                        </el-form-item>
                                                                                                                        

                                                        
                        <el-form-item  v-if="tableName=='xunlianrenyuan'" label="手机号" prop="shoujihao" :rules="{required: true, message: '手机号为必填项！', trigger: 'blur'}">
                            <el-input v-model="formData.shoujihao" maxlength="30" clearable show-word-limit placeholder="请输入手机号" />
                        </el-form-item>
