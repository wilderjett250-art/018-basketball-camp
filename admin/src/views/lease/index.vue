...
const { query,tableList,page,isdel,ids
     } = {...toRefs(state)};
...
function getDateList(){
   const params={
        ...
        if (state.query.funddate != '' && state.query.funddate != undefined) {
            params['funddate'] = '%' + state.query.funddate + '%'
        }
        if (state.query.enddate != '' && state.query.enddate != undefined) {
...
<template>
     ...
     <div class="layout-padding">
        <el-form inline :model="query" label-suffix=":">
            ...
            <el-form-item label="租借名称"  prop="title">
                    <el-input v-model="query.title" maxlength="100" placeholder="租借名称" clearable style="width: 200px;"/>
                </el-form-item>
                <el-form-item label="租借人"  prop="username">
                    <el-input v-model="query.username" maxlength="100" placeholder="租借人" clearable style="width: 200px;"/>
                </el-form-item>
                <el-form-item label="开始时间"  prop="funddate">
                    <el-date-picker v-model="query.funddate" type="date" maxlength="100"
                         format="YYYY/MM/DD"
        value-format="YYYY-MM-DD"
                    placeholder="开始时间" clearable style="width: 200px;"/>
                </el-form-item>
                <el-form-item label="结束时间"  prop="enddate">
                    <el-date-picker v-model="query.enddate" maxlength="100" type="date" 
                    format="YYYY/MM/DD"
        value-format="YYYY-MM-DD"
        ...
        <!-- <el-table
            ...
            <el-table-column header-align="center"  align="center" prop="title" label="租借名称">
        ...
        <template #default="{row}">
            {{row.type}}
                ...
                <el-table-column header-align="center"  align="center" prop="funddate" label="开始时间">
        ...
        <template #default="{row}">
            {{row.funddate}}
                ...
                <el-table-column header-align="center"  align="center" prop="enddate" label="结束时间">
        ...
        <template #default="{row}">
            {{row.enddate}}
                ...
                <template #default="{row}">
                    <el-popconfirm  v-if="isAuth('lease','删除')"  width="auto" @confirm="handleDelete(row)"  :title="`确定永久删除吗？`">
                        <template #reference>
