<script setup lang="ts">
      ...
      if (state.type == 'cross') {
        ...
        for (var o in obj) {
                    ...
                    continue;
                                                              ...
                                                              if (o == 'zhaoshourenshu') {
                    state.formData.zhaoshourenshu = obj[o];
                    state.roisfalg.zhaoshourenshu = true;
                    continue;
                  }
                                                              if (o == 'xiangqing') {
                    ...
                    continue;
                                                              ...
                                                              if (o == 'kaifangshijian') {
                    state.formData.kaifangshijian = obj[o];
                    state.roisfalg.kaifangshijian = true;
                    continue;
                  }
                                                              if (o == 'thumbsupnum') {
    ...
    function submitForm(){
        formRef.value?.validate((valid:boolean)=>{
          ...
          if (state.type == 'cross') {
            ...
            request({
              url:`xunlianyingxinxi/${!state.formData.id ? "save" : "update"}`,
              method:'post',
              data:state.formData
            }).then(({data})=>{
              notify("操作成功",{type:'success'});
    ...
    defineExpose({
        open
                                ...
                                async function xunlianyingxinxixunlianyingtupianhandleUploadImg(options: any){
              try {
                loadding.value = true;
            ...
            >
                        ...
                        <el-form-item label="训练营名称" prop="xunlianyingmingcheng" :rules="{required: true, message: '训练营名称为必填项！', trigger: 'blur'}">
                            ...
                            <el-upload
                                    ...
                                    :http-request="xunlianyingxinxixunlianyingtupianhandleUploadImg"
                            >
                        ...
                        <el-form-item label="招收人数" prop="zhaoshourenshu" :rules="{required: true, message: '招收人数为必填项！', trigger: 'blur'}">
                            <el-input v-model="formData.zhaoshourenshu" maxlength="30" clearable show-word-limit placeholder="请输入招收人数" :readonly="roisfalg.zhaoshourenshu"/>
                        </el-form-item>
                            ...
                            <Editor v-model="formData.xiangqing"/>
                                                                                ...
                                                                                <el-form-item label="开放时间" prop="kaifangshijian"  :rules="{required: true, message: '开放时间为必填项', trigger: 'blur'}">

                            <el-date-picker
                                    v-model="formData.kaifangshijian"
                                    type="date"
                                    format="YYYY/MM/DD"
