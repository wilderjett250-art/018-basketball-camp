<script setup lang="ts">
    ...
    const AddEdit=defineAsyncComponent(()=>import('@/views/discussbisaiguanli/add-edit.vue'));
    ...
    <el-card shadow="never" class="index">
        ...
        <div class="layout-padding">
            <el-form inline :model="query" label-suffix=":">
                  ...
                  <el-button v-if="isAuth('discussbisaiguanli','删除') && selectedPets.length > 0" icon="ele-Delete" @click="handleBatchDelete" type="danger">多选删除</el-button>
                    <el-button v-if="isAuth('discussbisaiguanli','新增')" icon="ele-Plus" type="success" @click="add()">新增</el-button>
                                                                            </el-form-item>
            </el-form>
                  ...
                  <tr v-for="pet in tableList" :key="pet.id" class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                      <div class="flex space-x-3">
                        <button v-if="isAuth('discussbisaiguanli','修改')" @click.stop="handleEdit(pet)" class="px-3 py-1 text-xs bg-green-500 text-white hover:bg-green-600 !rounded-button whitespace-nowrap">
                          <i class="fas fa-edit mr-1"></i>编辑
                        </button>
                        <button v-if="isAuth('discussbisaiguanli','删除')" @click.stop="handleDelete(pet)" class="px-3 py-1 text-xs bg-red-500 text-white hover:bg-red-600 !rounded-button whitespace-nowrap">
